    ...
    <div class="container mt-2 mb-5">
        <div class="row">
            <div class="col-md-6 mx-auto">
                ...
                <div class="p-4 my-3 shadow-sm loginformContainer d-flex">
                  

                 
                      <div class="col-12 mx-auto">
                          <form action="/register" class="signupbox" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="d-grid mt-5 mx-auto">   
                              ...
                              <button type="submit" id="submitbtn" name="submitLogin" class="btn rounded-5">Sign up</button>  
